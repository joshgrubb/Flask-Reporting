...
function loadAllData() {
    ...
    // Load main data
    $.ajax({
        url: '/reports/ssrs/no_occupant_list_for_moveouts/data',
        data: {
    ...
    // Load summary data
    $.ajax({
        url: '/reports/ssrs/no_occupant_list_for_moveouts/summary',
        data: {
            start_date: startDate,
            end_date: endDate
        },
...
function updateTotalStats(data) {
    ...
    const startDate = $('#startDate').val();
    const endDate = $('#endDate').val();
    $('#dateRangeInfo').text(`Moveouts from ${formatDate(startDate)} to ${formatDate(endDate)}`);
}
...
function exportReportData() {
    ...
    // Build export URL
    let url = '/reports/ssrs/no_occupant_list_for_moveouts/export';
