...
function loadAllData() {
    ...
    // Load main data
    $.ajax({
        url: '/groups/utilities_billing/accounts_no_garbage/data',
        dataType: 'json',
    ...
    $.ajax({
        url: '/groups/utilities_billing/accounts_no_garbage/street-summary',
        dataType: 'json',
        success: function (response) {
            if (response.success) {
...
function exportReportData() {
    ...
    window.open('/groups/utilities_billing/accounts_no_garbage/export', '_blank');
}
