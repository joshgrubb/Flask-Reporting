...
function loadAllData() {
    ...
    // Load main data
    $.ajax({
        url: '/groups/utilities_billing/new_customer_accounts/data',
    ...
    $.ajax({
        url: '/groups/utilities_billing/new_customer_accounts/account-types',
        data: { move_in_date: moveInDate },
        dataType: 'json',
        success: function (response) {
            if (response.success) {
    ...
    $.ajax({
        url: '/groups/utilities_billing/new_customer_accounts/daily-accounts',
        data: { move_in_date: moveInDate },
        dataType: 'json',
        success: function (response) {
            if (response.success) {
...
function exportReportData() {
    ...
    // Build export URL
    let url = '/groups/utilities_billing/new_customer_accounts/export';
    if (moveInDate) {
