...
from app.groups.utilities_billing.new_customer_accounts import bp
from app.groups.utilities_billing.new_customer_accounts.queries import (
...
def index():
    ...
    try:
        ...
        return render_template(
            "groups/utilities_billing/new_customer_accounts/index.html",
...
def get_report_data():
    ...
    try:
        ...
        if move_in_date_str:
            ...
            # Set to exactly midnight (start of day)
            move_in_date = move_in_date.replace(
        ...
        return jsonify(
            {
                ...
                "data": results,
                "count": len(results),
                "filters": {"move_in_date": move_in_date.strftime("%Y-%m-%d")},
            }
        )
